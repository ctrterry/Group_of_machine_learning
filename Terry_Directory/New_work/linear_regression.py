...
feature_labels = {
    ...
    'top_3_actor_scores': 'Log Top 3 Actor Social Media Score'
}
...
latex_table = coeff_df.to_latex(index=False, float_format="%.3f", caption="Linear Regression Coefficients for Predicting IMDb Ratings (2020--2025, 5-Fold CV)", label="tab:linear_regression_coeffs", column_format='lr', header=['Feature', 'Coefficient'], escape=True)

# save latex file
with open('/Users/terrychen/Desktop/Group_of_machine_learning/Terry_Directory/Data/Merege_data_with_Sasha/linear_regression_coeffs.tex', 'w') as f:
    f.write(latex_table)
...
results_df.to_csv('/Users/terrychen/Desktop/Group_of_machine_learning/Terry_Directory/New_work/resultlinear_regression_results.csv', index=False)
coeff_df.to_csv('/Users/terrychen/Desktop/Group_of_machine_learning/Terry_Directory/New_work/result/linear_regression_coeffs.csv', index=False)